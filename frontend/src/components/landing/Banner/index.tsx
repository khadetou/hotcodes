    ...
    <section className="h-[890px] flex items-center bg-grad-back blend relative ">
      <div className="flex flex-col items-center lg:flex-row translate-y-[-50%] md:mb-[75px] xsm:mb-[103px] lg:transform-none containers -mt-9">
        <div className="max-w-[734px] mb-4">
          <h1 className="text-white capitalize  leading-[1.2]  text-[40px] xs:text-[47px] xl:text-[67px] 2xl:text-[101px] 2xl:leading-none  font-light">
            {t("banner.h1")}
          </h1>
          ...
          <div className="flex md:mt-6">
            <Button
              className="text-[14px] px-[17px] py-[11px] xs:text-[15px] md:text-[18px] md:px-[19px]"
            ...
            <div className="md:ml-6 ml-[7px]">
              <Circular className="rounded-full xs:px-4 xs:py-4 p-[11px] bg-white text-primary shadow-btn" />
              <span className="text-white text-[14px] md:text-base xs:text-[14px] font-normal ml-[10px] uppercase">
                {t("banner.video")}
              </span>
            </div>
          </div>
        </div>
        <div className=" md:w-[228px] -mb-[65px] md:mb-0 lg:w-[1000px] w-[370px] mt-[10px] ">
